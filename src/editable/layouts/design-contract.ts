...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#1e2433',
  '--slot4-panel-bg': '#eef3fb',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#667085',
  '--slot4-soft-muted-text': '#7a8494',
  '--slot4-accent': '#4458e6',
  '--slot4-accent-fill': '#4458e6',
  '--slot4-accent-soft': '#e9edff',
  '--slot4-dark-bg': '#202637',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#e5eaf2',
  '--slot4-cream': '#f7f9fc',
  '--slot4-warm': '#ffffff',
  '--slot4-lavender': '#eef3ff',
  '--slot4-gray': '#f2f5f9',
  '--slot4-body-gradient': 'radial-gradient(circle at 12% 22%, rgba(117,205,255,0.22), transparent 30%), radial-gradient(circle at 88% 4%, rgba(255,177,193,0.22), transparent 28%), linear-gradient(180deg, #f6f8fc 0%, #ffffff 42%, #f2f5f9 100%)',
  '--editable-page-bg': '#f5f7fb',
  '--editable-page-text': '#1e2433',
  '--editable-border': 'rgba(30,36,51,0.10)',
...
export const editableDesignContract = {
  ...
  type: {
    ...
    heroTitle: 'text-4xl font-extrabold leading-[1.05] sm:text-5xl lg:text-[3.25rem]',
    sectionTitle: 'text-3xl font-extrabold sm:text-4xl',
